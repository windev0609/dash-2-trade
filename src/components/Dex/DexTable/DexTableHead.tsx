...
import DexCellHead from "./DexCellHead";
          ...
          >
            {(droppableProvided) => (
              <div
                ...
                className="h-[4.125rem] w-full border-y border-border-primary min-w-[100%]"
              >
                    ...
                    {(provided, snapshot) => (
                      ...
                      >
                        <div
                          ...
                          className="h-[100%] p-2 flex items-center justify-center"
                        >
                          <DexCellHead
                            column={column}
                            onChange={column.id ? onPriceHistoryChange : null}
                          />
                        </div>
                      </div>
                    )}
